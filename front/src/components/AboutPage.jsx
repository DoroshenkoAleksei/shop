  ...
  return (
    <div id="content">
      ...
      >
        ...
        <br />
        M.A.D.(США). Приобретая у нас косметику брендов Soskin, SkinClinic. ECLADO,
        <br /> RENOPHASE, M.A.D. , Вы можете быть уверенны в эффективности и <br />
      ...
      >
        ...
        <br />
        имидж и качество вашей жизни, предлагая медицинские и косметические <br />
      ...
      <img
        src="/media/images/Rectangle_32.png"
        alt="some"
      ...
      >
        ...
        технологий, традиционных ценных компонентов и современного подхода к <br />
        ...
        длительный устойчивый результат. Высокая концентрация растительных <br />
        ...
        <br />
        Широкий ассортимент продуктов - более 120 наименований - позволяет <br />
        предложить клиентам эстетические программы, решающие разнообразные <br />
      ...
      >
        ...
        представлений о физиологии процессов старения, механизмов действия <br />
        anti-age- компонентов, накопленного многолетнего практического опыта <br />
        ...
        <br />
        Инновационные формулы отвечают самым взыскательным требованиям пациентов.
      </h3>
      <h1
        style={{
          fontFamily: "Poppins",
      ...
      >
        ...
        <br />
        производства. M.A.D. Skincare представляет серии косметики, действие которых{" "}
        <br />
        направлено на омоложение, осветление, восстановление, выравнивание и <br />
      ...
      <img
        src="/media/images/Rectangle_36.png"
        alt="some"
      ...
      >
        geneus description TRATATRATATRATATRATAT
        <br />
        RATATRATATRATATRATATRATATRATATRATATRATATRATATRATATRATA
      </h3>
      <br />
      <br />
      <br />
